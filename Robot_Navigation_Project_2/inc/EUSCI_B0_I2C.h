/**
 * @file EUSCI_B0_I2C.h
 * @brief Header file for the b driver.
 *
...
#ifndef INC_EUSCI_B0_I2C_H_
#define INC_EUSCI_B0_I2C_H_

#include <stdint.h>
#include "msp.h"

#define EN_I2C_RD_WR 1
 ...
 *       initialized using the EUSCI_B0_I2C_Init function.
 *
 * @return None
 */
