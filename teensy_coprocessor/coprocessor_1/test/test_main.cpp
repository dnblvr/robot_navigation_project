 ...
 *
 *        9 tests total:
 *          ICP_2D / ICP_2D_i (6) + GraphSLAM pipeline (3)
 *
 *        Environments:
...
// wiring.h declares setup/loop inside extern "C" { }, so definitions must
// carry the same C linkage or the linker will not find them.
