 ...
 *
 * @note This file was re-purposed for profiler duties.
 *
 * @author Aaron Nanas (originator)
 * @author Gian Fajardo
 *
 */
 ...
 *  The interrupts will occur at a specified interval determined by the
 *  'clock_cycles' parameter, which is provided in terms of the bus clock
 *  period. The function also allows setting the priority level of the SysTick
 *  interrupt handler using the 'priority' parameter.
 *
 ...
 *                     The actual time between interrupts will depend on the
 *                          system clock frequency and the 'clock_cycles' value.
