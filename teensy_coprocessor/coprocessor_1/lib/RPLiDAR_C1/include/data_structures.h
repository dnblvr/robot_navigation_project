 ...
 * @brief Shared data structures for LiDAR scan processing and SLAM.
 *
 * @note Lifted verbatim from the MSP432 FW_RPLiDAR_C1 project; no
...
/**
 * @brief Maximum number of points in a single processed scan frame.
 */
