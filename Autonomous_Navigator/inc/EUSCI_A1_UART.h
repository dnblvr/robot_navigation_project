...
/**
 * @brief The EUSCI_A1_UART_Ramp_Data function transmits the values 0 to 255 to the UART Transmit Buffer.
 *
 * The EUSCI_A1_UART_Ramp_Data function tests the EUSCI_A1_UART module using a loopback test. A loopback test can be done by
 * connecting the P3.3 pin (UART TX) to the P3.2 pin (UART RX). The EUSCI_A1_UART_OutChar function will transmit the values 0 to 255 and write
 * the values to TX_Buffer. Then, the EUSCI_A1_UART_InChar function will read the value from the UART Receive Buffer and the received
...
/**
 * @brief The EUSCI_A1_UART_Validate_Data function verifies if the data sent and the data received are the same.
 *
 * The EUSCI_A1_UART_Validate_Data function is used to verify whether or not the loopback test was successful by comparing
