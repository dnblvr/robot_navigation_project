 ...
 *         (modified by Gian Fajardo for the MSP432 platform)
...
#define AK09916_CONTROL_2       0x31
    ...
    #define SINGLE_MODE         BIT_MASK(0)
    #define CONTINUOUS_10HZ     BIT_MASK(1)
    #define CONTINUOUS_20HZ     BIT_MASK(2)
    #define CONTINUOUS_50HZ     (BIT_MASK(2) | BIT_MASK(1))
    #define CONTINUOUS_100HZ    BIT_MASK(3)
    #define SELF_TEST_MODE      BIT_MASK(4)
...
#define INT_PIN_CFG             0x0F
    ...
    #define INT1_ACTL       BIT_MASK(7)
    #define INT1_OPEN       BIT_MASK(6)
    #define INT1_LATCH_EN   BIT_MASK(5)

/**
 * @brief switches to I2C bypass mode, enabling direct access to the
 *  magnetometer
 */
#define INT1_BYPASS_EN      BIT_MASK(1)
...
#define INT_ENABLE              0x10
    ...
    #define I2C_MST_INT_EN  BIT_MASK(0)
